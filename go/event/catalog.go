...
func Catalog() []CatalogEntry {
	return []CatalogEntry{
		...
		{EventType: TypeIBChangeRequestedV1, Producer: ProducerIB},
		{EventType: TypeIBChangeApprovedV1, Producer: ProducerIB},
		{EventType: TypeIBChangeRejectedV1, Producer: ProducerIB},
